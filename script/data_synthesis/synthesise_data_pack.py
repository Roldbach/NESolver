#! /usr/bin/env python
"""The script used to synthesis data used for multivariate ion analysis.
...
from NESolver.data_synthesis import DataPackSynthesiser
...
SCOPE_TO_SAMPLE_NUMBER = {
    ...
    (1e-4, 1e-2): 50,
}  # The overall ionic strength must be < 0.1M due to the limitation of the
...
def synthesis_data_pack(
    ...
    data_pack_synthesiser = DataPackSynthesiser.DataPackSynthesiser(
        charge, ion_size, selectivity_coefficient, noise_parameter)
    data_pack = data_pack_synthesiser.synthesis(scope_to_sample_number)
    return data_pack
# }}}
