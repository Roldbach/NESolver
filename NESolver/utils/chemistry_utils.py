...
Ag_AgCl_RESPONSE_INTERCEPT = 0.197  # Standard reduction potential of Ag/AgCl
                                    # reference electrode with saturated KCl at
                                    # 25 celsius
...
"""----- Response Slope -----"""
# {{{ compute_Nernst_response_slope
def compute_Nernst_response_slope(
    charge: np.ndarray,
    ...
    response_slope = numerator / denominator
